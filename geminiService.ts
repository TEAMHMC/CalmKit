...
const HYPE_SCRIPTS = {
  en: {
    ...
    moving: [
      ...
      "Most people negotiate with their fear. I will do it when I feel ready, when the time is right. You stopped negotiating. You showed up. That is the whole difference.",
      ...
      "What are you doing with everything in you? The gift, the story, the fight. This is the moment to use some of it. Right here. Don't save it all for a better day. This is the day.",
      "Every great thing you will build started with a moment exactly like this one. You showed up when it would have been easier not to. Do not underestimate this moment.",
