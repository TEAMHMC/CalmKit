...
// Voice: Iyanla Vanzant — warm, maternal, "beloved," truth-telling.
// CBT: Body scan, safety cues, self-compassion reframes, grounding.
// ─────────────────────────────────────────────────────────────
const HOPE_SCRIPTS = {
  en: {
    greeting: [
      "Beloved — before we take one step, just breathe. In through the nose, out through the mouth. You carried a lot to get here. That weight doesn't have to move with you. Let the breath take some of it. Now let's walk.",
      "You showed up today. That's the first piece of work. Iyanla Vanzant says until you heal the wounds of your past, you will continue to bleed — and this walk, beloved? This is how we stop the bleeding. One step at a time.",
      "Feel your feet on the ground. That's real. That's you — present, alive, choosing yourself today. Not tomorrow's version of you. Today's. Whatever is going on in your life, your body brought you here. Honor that. Let's go.",
      "You don't have to be healed to start. You don't have to be okay to move. You just have to be here — and you are. That's all the permission you need. The work begins with showing up, and beloved, you already did that.",
      "Before your first step — take one honest breath. Whatever you're holding, wherever you're hurting — bring it with you. We don't leave pieces of ourselves behind. We bring the whole truth. Let's move.",
    ],
    moving: [
      "Notice your body right now — not to judge it, just to feel it. Where are you carrying today? Shoulders tight? Chest heavy? Just say hello to it. Awareness is the first act of healing.",
      "Iyanla Vanzant says forgiveness is letting go of the hope that the past could have been any different. What if you took one step forward today as an act of letting go? Not forgiving everything. Just one step of releasing.",
      "You are not your pain. You are not your past. You are not the hard thing that happened to you. You are the one who showed up today after all of it. That's your true identity. Walk it.",
      "Your body has been keeping you safe your whole life — even when you didn't know it needed to. Every breath you've taken, every step that brought you here. That's not small. That's profound. Receive that.",
      "There is a kind of strength that doesn't look strong. It looks like being soft on a hard day. It looks like moving when everything in you wanted to stay still. That's what you're doing right now. Don't underestimate it.",
      "The truth about healing — it is not linear. Some days you go forward three steps and back one. Some days you just hold your ground. Right now? You're moving. And moving is not the same as staying stuck.",
      "Look around you. You are moving through your community. You belong here. Not someday — now. Not when you're fixed or whole or done with the hard work — now. Exactly as you are.",
      "What are you carrying right now that was never yours to carry? Some of what weighs on you was handed to you long before you were old enough to refuse it. You are allowed to set some of it down.",
      "Scan your body from your feet up. Not to fix anything. Just to say: I see you. I'm here. That kind of presence — to your own self — is the work. You are practicing it right now.",
      "Being gentle with yourself is a learned skill. Most of us were raised in hard places that never modeled it. Choosing softness toward yourself on a hard day — that's radical. That's what you're doing right here.",
      "Every person moving through these streets is carrying something invisible. You are not alone in what you're holding. Not even close. There is a whole community of people who understand the weight — even if they don't say it.",
      "Your heart has been working for you without being asked. Beating through every hard season, every sleepless night, every moment you thought you couldn't. It didn't give up on you. Be here for it.",
      "Healing happens when we stop running from the truth of our own lives and start walking toward it. That's what this is — one of those walks. You are closer to your own truth than you think.",
      "Whatever you're working through — you don't have to resolve it on this walk. Just let it be present without letting it take over. That's the practice. Presence without possession.",
      "There is no shame in where you've been. Shame is a lie that says the broken parts mean you can't be made whole. This walk — moving, breathing, staying — is how you answer that lie.",
      "You survived everything that tried to break you. Every single thing. Not because you're invincible — because you are more resilient than you've been taught to believe. That resilience brought you here today.",
      "You have given your pain a lot of your energy. It's your turn now. This walk, this time, this breath — this is yours. Take it.",
      "The work doesn't always feel like work. Sometimes it feels like a walk through the neighborhood. But showing up to yourself — again and again — is the whole practice. You are doing the work right now.",
      "You're further into this than when you started. What's shifted, even slightly? Maybe nothing yet. Maybe something. Pay attention — your body usually knows before your mind catches up.",
      "Past the hard part. You stayed with yourself today — showed up and stayed. Bring that same faithfulness to the rest of your day, beloved. That person who stayed? That's who you really are.",
    ],
    midpoint: [
      "You're still here. Your body has been showing up for you this whole time — heart beating, lungs breathing — even when you felt like you couldn't. Take a quiet moment to acknowledge that faithfulness.",
      "Halfway through. The walk is already doing its work — sometimes before you notice it. What's shifted, even slightly, since you started? A small shift is still a shift.",
      "You are not a problem to be solved, beloved. You are a person who deserves care. Not because you earned it. Not because you've been good enough. Because you are here, and here is enough.",
      "Sometimes healing looks quiet. It looks like a walk through the neighborhood with no one watching. It looks exactly like this. Don't discount it because it feels ordinary. The ordinary moments are where the real work lives.",
    ],
    closing: [
      "You stayed with yourself today. That's the whole thing — you stayed. Bring that same faithfulness into the rest of your day. You have more capacity to show up for yourself than you've been letting yourself believe.",
      "Slow it down. Feel your feet on the ground. Feel this moment. You moved through something today — even if that something was just another hard day. That counts. That always counts.",
      "Whatever you carried here — you carried it with a little more grace today. Iyanla says the work is never done, but today you did some of it. Be proud of that, beloved. You did the work.",
      "End of this session. Take what you found here — one breath, one step, one moment of choosing yourself — and let it be the first thing you lead with today. Not the last. The first.",
    ],
  },
  es: {
    greeting: [
      "Amada — antes de dar un paso, solo respira. Adentro por la nariz, afuera por la boca. Cargaste mucho para llegar aquí. Ese peso no tiene que seguirte. Deja que la respiración lleve algo de eso. Ahora caminemos.",
      "Te presentaste hoy. Ese es el primer trabajo. Lo que sea que estés cargando — tráelo contigo. No dejamos partes de nosotros mismos atrás. Traemos toda la verdad. Vamos.",
      "Siente tus pies en el suelo. Eso eres tú — presente, vivo, y apareciendo para ti mismo. No la versión de mañana. La de hoy. Tu cuerpo te trajo aquí. Honra eso.",
      "No tienes que estar sano para empezar. No tienes que estar bien para moverte. Solo tienes que estar aquí — y estás. Eso es todo el permiso que necesitas.",
      "Antes de tu primer paso — toma una respiración honesta. Cualquier cosa que estés sosteniendo, donde sea que estés lastimado — tráelo contigo. Vamos a caminar con toda la verdad.",
    ],
    moving: [
      "Nota tu cuerpo ahora mismo — no para juzgarlo, solo para sentirlo. ¿Dónde estás cargando el día de hoy? Hombros tensos, pecho pesado. Solo dile hola. La conciencia es el primer acto de sanación.",
      "Hay un tipo de fortaleza que no se ve fuerte. Se ve como ser suave en un día difícil. Se ve como moverte cuando todo en ti quería quedarse quieto. Eso es lo que estás haciendo ahora mismo.",
      "La sanación no es lineal. Algunos días avanzas tres pasos y retrocedes uno. Algunos días solo mantienes tu terreno. En este momento — te estás moviendo. Y moverse no es lo mismo que estar estancado.",
      "Mira a tu alrededor. Te estás moviendo por tu comunidad. Perteneces aquí. No algún día — ahora. Exactamente como eres.",
      "Lo que cargas ahora mismo — ¿qué parte de eso nunca fue tuya para cargar? Algo del peso te fue entregado mucho antes de que pudieras rechazarlo. Se te permite poner parte de eso en el suelo.",
      "Escanea tu cuerpo de los pies hacia arriba. No para arreglar nada. Solo para decir: te veo. Estoy aquí. Ese tipo de presencia — hacia ti mismo — es el trabajo.",
      "Ser gentil contigo mismo es una habilidad aprendida. La mayoría de nosotros crecimos en lugares difíciles que nunca lo modelaron. Elegir suavidad hacia ti mismo en un día difícil — eso es radical.",
      "La sanación sucede cuando dejamos de huir de la verdad de nuestras propias vidas y empezamos a caminar hacia ella. Eso es lo que es esto — una de esas caminatas.",
      "No hay vergüenza en donde has estado. La vergüenza es una mentira que dice que las partes rotas significan que no puedes ser restaurado. Este caminar — moverse, respirar, quedarse — es cómo respondes a esa mentira.",
      "Sobreviviste todo lo que trató de romperte. Cada cosa. No porque seas invencible — porque eres más resiliente de lo que te han enseñado a creer.",
    ],
    midpoint: [
      "Todavía estás aquí. Tu cuerpo ha estado apareciendo por ti todo este tiempo — corazón latiendo, pulmones respirando — incluso cuando sentiste que no podías. Tómate un momento tranquilo para reconocer esa fidelidad.",
      "A la mitad. La caminata ya está haciendo su trabajo — a veces antes de que lo notes. ¿Qué ha cambiado, aunque sea ligeramente, desde que empezaste?",
      "No eres un problema a resolver, amada. Eres una persona que merece cuidado. No porque te lo hayas ganado. Porque estás aquí, y aquí es suficiente.",
      "A veces sanar se ve tranquilo. Se ve como una caminata por el vecindario. Se ve exactamente así. No lo descartes porque parece ordinario — los momentos ordinarios son donde vive el trabajo real.",
    ],
    closing: [
      "Te quedaste contigo mismo hoy. Eso es todo — te quedaste. Lleva esa misma fidelidad al resto de tu día.",
      "Disminuye la velocidad. Siente tus pies en el suelo. Te moviste a través de algo hoy — incluso si ese algo fue solo otro día difícil. Eso cuenta.",
      "Lo que sea que trajiste aquí — lo cargaste con un poco más de gracia hoy. Hiciste el trabajo. Sé orgulloso de eso, amada.",
      "Fin de esta sesión. Lleva lo que encontraste aquí — un aliento, un paso, un momento de elegirte — y deja que sea lo primero con lo que lideres hoy. No lo último. Lo primero.",
    ],
  },
};
...
const HYPE_SCRIPTS = {
  en: {
    ...
    moving: [
      ...
      "Past the hard part. Now momentum is carrying you. Lean into it. The grind already happened — now it's just finish.",
      "The last stretch is where most people pull back. Not because they can't — because they think they've already done enough. You haven't. You're almost there. Finish strong.",
      "Every great thing you'll build started with a moment exactly like this one — you showing up when it would've been easier to stay still. Don't underestimate this moment.",
      "You've been at this long enough that it's real now. This is where character actually shows up. Not in the first block — in this one. Show yours.",
    ],
    midpoint: [
