    ...
    switch (view) {
      ...
      case 'ABOUT': return (
        <div className="flex-1 px-5 py-6 flex flex-col gap-5 animate-in fade-in overflow-hidden">
          ...
          <button onClick={() => setView('HOME')} className="h-14 bg-black dark:bg-white text-white dark:text-black rounded-full font-normal text-base shadow-lg flex items-center justify-center active:scale-95">Back</button>
        </div>
      );
