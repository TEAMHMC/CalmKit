    ...
    switch (view) {
      ...
      case 'ABOUT': return (
        <div className="flex-1 p-8 flex flex-col gap-6 animate-in fade-in overflow-y-auto">
          ...
          <button onClick={() => setView('HOME')} className="mt-4 h-14 bg-black dark:bg-white text-white dark:text-black rounded-full border border-[#0f0f0f] dark:border-white font-normal text-base shadow-lg flex items-center justify-center gap-2">Back</button>
        </div>
      );
