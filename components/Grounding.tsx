      ...
      <div className="flex-1 flex flex-col items-center justify-center text-center">
        {!done ? (
          <div className="w-full space-y-12 animate-in slide-in-from-right-4">
             <div className="space-y-2">
                ...
                <div className="relative -mt-16">
                   <h3 className="text-4xl font-black uppercase tracking-tighter dark:text-white">{steps[step].action}</h3>
          ...
          <div className="space-y-8 animate-in zoom-in duration-500">
             ...
             <div className="space-y-2">
               <h3 className="text-3xl font-black uppercase italic dark:text-white">{t.labels.youArePresent}</h3>
