...
const Journal: React.FC<JournalProps> = ({ onBack, lang }) => {
  ...
  if (showHistory) {
    return (
      <div className="flex-1 flex flex-col bg-white dark:bg-[#121212] overflow-hidden">
        <div className="border-b border-gray-100 dark:border-white/10 px-5 py-4 space-y-2">
        ...
        <div className="flex-1 overflow-y-auto px-5 py-4 space-y-4 scrollbar-hide">
          ...
          {entries.map(e => (
            <div key={e.id} className="p-5 bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/10 rounded-2xl space-y-3 relative group">
              <div className="flex items-center justify-between">
  ...
  return (
    <div className="flex-1 flex flex-col bg-white dark:bg-[#121212] overflow-hidden">
      <div className="px-5 py-5 border-b border-gray-100 dark:border-white/10 flex-shrink-0">
      ...
      <div className="flex-1 flex flex-col p-5 gap-4 overflow-hidden min-h-0">
        <div className="flex-1 flex flex-col bg-gray-50/50 dark:bg-white/5 rounded-2xl overflow-hidden border border-gray-100 dark:border-white/10 min-h-0">
          <textarea
            value={response}
        ...
        <div className="relative flex-shrink-0">
          ...
          <button
            ...
            className="w-full h-16 bg-black dark:bg-white text-white dark:text-black rounded-full font-normal text-base flex items-center justify-center gap-3 disabled:opacity-20 transition-all active:scale-95 shadow-xl"
          >
